...
\cventry
  {Founder} % Job title
  {www.miguelacademy.com} % Organization
  {Lima - Per\'u} % Location
...
%---------------------------------------------------------
  \cventry
  {Prestador de Servicio} % Job title
  {Ministerio de Desarrollo e Inclusión Social} % Organization
  {Lima - Per\'u} % Location
  {2020} % Date(s)
  {
\begin{cvitems} % Description(s) of tasks/responsibilities
  \item {Servicio para el apoyo en la evaluación, definición,
         actualización, realización de pruebas y validaciones de las
         reglas de consistencia para su aplicación en la información
         recogida en los instrumentos de recojo de datos para la
