...
%---------------------------------------------------------
  \cventry
  {Data Developer} % Job title
  {Proyecto: Diseño e implementación de un sistema automatizado para obtener la geometría del eje de una carretera usando métodos de reinforcement learning} % Organization
  {Lima - Per\'u} % Location
  {2020 - 2021} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
